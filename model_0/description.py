...
config ={
  ...
  'modelParams' : {'tmParams': {'minThreshold': 10, 'activationThreshold': 14, 'pamLength': 3}, 'sensorParams': {'encoders': {u'cpu': {'maxval': 100.0, 'name': 'cpu', 'clipInput': True, 'minval': 0.0, 'n': 271, 'fieldname': 'cpu', 'w': 21, 'type': 'ScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.055188392222390525}, 'clParams': {'alpha': 0.059171481062032134}},
