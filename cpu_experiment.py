...
def run_sine_experiment():
  ...
  if PLOT:
    output = NuPICPlotOutput("cpu2_output", show_anomaly_score=True)
  else:
    output = NuPICFileOutput("cpu2_output", show_anomaly_score=True)
  ...
  with open(input_file, "rb") as sine_input:
    ...
    for row in csv_reader:
      ...
      output.write(timestamp, cpu, result, prediction_step=1)
